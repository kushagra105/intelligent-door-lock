...
def upload_image():
	...
	object = s3.Object('guest-images-collection','sample.jpg')
...
def send_email(): 
    fromaddr = "allahabadi1508@gmail.com"
    toaddr = "jaiswal.kushagra105@gmail.com"
    ...
    body = "The guest is waiting at the door, The Photo is attached."
    ...
    server.starttls()
    server.login(fromaddr, "Baloney_1google")
    text = msg.as_string()
